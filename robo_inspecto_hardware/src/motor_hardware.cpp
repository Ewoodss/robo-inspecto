...
{
hardware_interface::CallbackReturn MotorHardware::on_init(
...
hardware_interface::CallbackReturn MotorHardware::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
PLUGINLIB_EXPORT_CLASS(
  robo_inspecto_hardware::MotorHardware, hardware_interface::ActuatorInterface)
