...
#ifndef ROBO_INSPECTO_HARDWARE__VISIBILITY_CONTROL_H_
#define ROBO_INSPECTO_HARDWARE__VISIBILITY_CONTROL_H_
...
#endif  // ROBO_INSPECTO_HARDWARE__VISIBILITY_CONTROL_H_
